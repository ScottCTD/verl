...
class RuleProcessRewardManager:
    ...
    def create_char_to_token_map(self, token_ids: torch.Tensor) -> Tuple[str, List[int]]:
        pieces = []
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        for i in range(len(data)):
            ...
            response_str, token_index_map = self.create_char_to_token_map(clean_ids)
